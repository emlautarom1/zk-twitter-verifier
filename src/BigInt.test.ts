...
describe("BigInt JS", () => {
  ...
  it("squares in modulo (large)", () => {
    let x = ;
    let m =
    ;

    let res = UInt2048.fromBigInt(x).mulMod(UInt2048.fromBigInt(x), UInt2048.fromBigInt(m));

    expect(res.toBigInt()).toBe((x * x) % m);
  });
});
